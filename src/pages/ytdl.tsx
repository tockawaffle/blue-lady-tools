...
export default function YtDlp() {
    ...
    useEffect(() => {
        ...
        return install_deps(Ytdlp, setDeps, setCompleted);
    }, []);
    ...
    async function handleDownload() {
        ...
        try {
            ...
            const success = await TauriApi.Ytdlp.TauriYtdlpApi.DownloadVideo(opts);
    ...
    return (
        <>
            ...
            {completed ? (
                ...
                <DepsInstallModal step={deps.step} percentage={deps.percentage} eta={deps.eta}/>
            )}
        </>
    );
}
